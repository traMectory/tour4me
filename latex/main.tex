...
%% article.
\begin{abstract}
The touring problem is a generalization of the arc orienteering problem;  
in addition to maximizing edge profit, the touring problem optimizes attributes not depending only on single edges, for example maximizing the area covered by an tour.
